                 ...
                 <div class="col-md-9">
                                      ...
                                      <li>
                                        <img src="slide4.jpg" />
                                          ...
                                          <div id="slider" class="flexslider">
                                            <ul class="slides">
                                              <li>
                                                <img src="assets/images/item-img-1-1.jpg" alt="">
                                              </li>
                                              <li>
                                                <img src="assets/images/item-img-1-2.jpg" alt="">
                                              </li>
                                              <li>
                                                <img src="assets/images/item-img-1-3.jpg" alt="">
                                              </li>
                                              <li>
                                                <img src="assets/images/item-img-1-1.jpg" alt="">
                                              </li>
                    ...
                    <section class="padding-top-30 padding-bottom-0">
                       ...
                       <div class="item-slide-4 with-nav">
                          ...
                          <div class="product">
                             <article>
                                <img class="img-responsive" src="assets/images/item-img-1-1.jpg" alt="" >
                                <!-- Content -->
                          ...
                          <div class="product">
                             <article>
                                <img class="img-responsive" src="assets/images/item-img-1-2.jpg" alt="" > <span class="sale-tag">-25%</span>
                                <!-- Content -->
                          ...
                          <div class="product">
                             <article>
                                <img class="img-responsive" src="assets/images/item-img-1-3.jpg" alt="" >
                                <!-- Content -->
                          ...
                          <div class="product">
                             <article>
                                <img class="img-responsive" src="assets/images/item-img-1-4.jpg" alt="" > <span class="new-tag">New</span>
                                <!-- Content -->
                          ...
                          <div class="product">
                             <article>
                                <img class="img-responsive" src="assets/images/item-img-1-5.jpg" alt="" >
                                <!-- Content -->
                          ...
                          <div class="product">
                             <article>
                                <img class="img-responsive" src="assets/images/item-img-1-6.jpg" alt="" > <span class="sale-tag">-25%</span>
                                <!-- Content -->
                                <span class="tag">Tablets</span> <a href="#." class="tittle">Mp3 Sumergible Deportivo Slim Con 8GB</a>
                                <!-- Reviews -->
                                <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star-o"></i> <span class="margin-left-10">5 Review(s)</span></p>
                          ...
                          <div class="product">
                             <article>
                                <img class="img-responsive" src="assets/images/item-img-1-7.jpg" alt="" >
                                <!-- Content -->
                                <span class="tag">Appliances</span> <a href="#." class="tittle">Reloj Inteligente Smart Watch M26 Touch </a>
                                <!-- Reviews -->
                                <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star-o"></i> <span class="margin-left-10">5 Review(s)</span></p>
                          ...
                          <div class="product">
                             <article>
                                <img class="img-responsive" src="assets/images/item-img-1-8.jpg" alt="" > <span class="new-tag">New</span>
                                <!-- Content -->
                                <span class="tag">Accessories</span> <a href="#." class="tittle">Teclado Inalambrico Bluetooth Con Air Mouse</a>
                                <!-- Reviews -->
                                <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star-o"></i> <span class="margin-left-10">5 Review(s)</span></p>
